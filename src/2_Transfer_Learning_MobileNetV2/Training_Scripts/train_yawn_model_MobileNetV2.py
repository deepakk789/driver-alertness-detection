"""
MobileNetV2 Transfer Learning — Yawn Model Comparison
======================================================
This script trains TWO MobileNetV2 variants for yawn/no-yawn classification
...
TRAIN_DIR = r"D:\project folder\DRIVER ALLERTNESS DETECTION SYSTEM\DATASET_COMBINED\TRAIN\YAWN_TRAIN"
VAL_DIR   = r"D:\project folder\DRIVER ALLERTNESS DETECTION SYSTEM\DATASET_COMBINED\VALIDATION\YAWN_VAL"
TEST_DIR  = r"D:\project folder\DRIVER ALLERTNESS DETECTION SYSTEM\DATASET_COMBINED\TEST\YAWN_TEST"
...
train_datagen = ImageDataGenerator(
    ...
    brightness_range=[0.5, 1.5],   # ← simulate dim/bright lighting
...
frozen_callbacks = [
    ...
    ModelCheckpoint("Models/yawn_model_mobilenet_frozen.h5", save_best_only=True)
]
...
tuned_callbacks = [
    EarlyStopping(patience=5, restore_best_weights=True),
    ModelCheckpoint("Models/yawn_model_mobilenet_tuned.h5", save_best_only=True)
]
...
custom_model = load_model("Models/yawn_model.h5")
...
# ===========================
print("\n" + "="*60)
print("YAWN MODEL COMPARISON RESULTS")
print("="*60)
