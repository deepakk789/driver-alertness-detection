...
**Dataset:** The models were trained on a curated composite dataset of 60,000+ images (aggregating public data with custom-collected frames), which I have published on Kaggle.
